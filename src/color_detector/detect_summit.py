...
class box_detector:
  ...
  def callback(self,data):
    ...
    #8 bit have 255 as max value, H has 180 max, we want low V and low saturation to get black and gray areas of summit
    gray_mask = cv.inRange(image_hsv, (0,0,0), (255,150,150) ) 
...
if __name__ == '__main__':
  ic = box_detector()
  rospy.init_node('summit_color_detector', anonymous=True)
  print('starting node')
  try:
    rospy.spin()
